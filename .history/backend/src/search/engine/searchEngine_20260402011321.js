...
class SearchEngine {
  async search(query) {
    ...
    //  query vector banaate hain TF-IDF ke according to the query terms, jisse hum cosine similarity ke liye use karenge. 
    // Query ke liye bhi log-normalized TF use karte hain, taaki ranking me better results mile.
    ...
    //  STORE IN CACHE
    // good for fast retrieval of recent queries, but can lead to stale results if documents are updated frequently.
