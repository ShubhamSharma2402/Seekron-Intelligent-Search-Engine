...
// Top-3 rank ke gradient colors
// visually differentiate top 3 results with special colors, baaki ke liye neutral grey gradient
...
const ResultCard = ({ result, query, rank, maxScore, style }) => {
  // percentage score calculate karte hain relative to maxScore, aur uske hisab se color choose karte hain
  const scorePercent =
